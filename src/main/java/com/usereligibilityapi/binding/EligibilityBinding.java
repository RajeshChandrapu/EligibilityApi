package com.usereligibilityapi.binding;
...
public class EligibilityBinding {
	...
	public EligibilityBinding(String name, Long mobile, String email, Character gender, Long ssn, String planNAme,
	...
	public String toString() {
		return "EligibilityBinding [name=" + name + ", mobile=" + mobile + ", email=" + email + ", gender=" + gender
